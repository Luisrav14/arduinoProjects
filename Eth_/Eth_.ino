...
IPAddress ip(192,168,101,49); //Asignamos  la IP al Arduino
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == 'n' && currentLineIsBlank) {
            ...
            client.println("<html>");                 
            client.println("<head><title>Arduino Status</title>");
            client.println("</head>");
            client.println("<body>");
            client.println("<div style='text-align:center;'>");
            client.println("<h1>Arduino Status</h1>");
            ...
            client.println("<a href='http://192.168.101.177'>Actualizar entradas</a>");
