...
//Conectaremos el sensor infrarrojo a un pin DIGITAL del Arduino, en este caso sera el pin 8

IRrecv sensor(8);                 //Inicializamos el sensor infrarrojo, poniendo el pin digital 8 como parametro
...
void setup()
{
  servomotor.attach(9); //Pin PWM 6 del Arduino donde conectamos el servo
